...
import { Ammount, BackIcon, DateHistory, Description, MoreDetails } from '../../../Styles/UI-Wallance';
          ...
          return (
            <HistoryContent key={item.id}>
              ...
              <MoreDetails>
                ...
                <Ammount className={`${item.amount < 0 ? 'negative' : 'positive'}`}>{item.amount},00</Ammount>
              </MoreDetails>
            </HistoryContent>
          );
        })}
